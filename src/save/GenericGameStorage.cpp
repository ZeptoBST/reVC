...
bool StillToFadeOut;
bool autoSave = 0; // ZAdd: Value that decides if the game should pass time. #AutoSave
...
{
	if(autoSave != 1) // ZAdd: Don't pass time when autosaving. #AutoSave
	...
	CGame::TidyUpMemory(true, false);
	autoSave = 0; // ZAdd: Reset the value after use. #AutoSave
}
